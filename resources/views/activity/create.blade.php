                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('activity.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="avatar" type="file" class="form-control" id="input-avatar" value="{{ old('avatar') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="intro" class="form-control" id="input-intro" rows="3">{{ old('intro') }}</textarea>
