    ...
    <div class="topbar">
        ...
        <div class="topbar-left">
            <div class="text-center">
                <a href="index.html" class="logo"><span>Web</span>Admin</a>
                <a href="index.html" class="logo-sm"><span>W</span></a>
                <!--<a href="index.html" class="logo"><img src="{{ asset('assets/webadmin/images/logo_white_2.png') }}" height="28"></a>-->
                <!--<a href="index.html" class="logo-sm"><img src="{{ asset('assets/webadmin/images/logo_sm.png') }}" height="36"></a>-->
            </div>
        </div>
        ...
        <div class="sidebar-inner slimscrollleft">
            ...
            <div id="sidebar-menu">
                <ul>
                    ...
                    <li class="has_sub">
                        <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-album"></i> <span> User Interface </span> <span class="pull-right"><i class="mdi mdi-plus"></i></span></a>
